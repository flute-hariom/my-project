        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="hover:text-cyan-400 transition-colors duration-300 flex group"
                >
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <div className="flex-shrink-0">
              <Link
                href="/"
                className="flex text-white text-xl font-bold hover:text-cyan-400 transition-colors duration-300 mb-20"
              >
